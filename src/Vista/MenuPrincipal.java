...
public class MenuPrincipal extends JFrame{
    ...
    public JButton jbAdmin,jbCliente,jbProductos,jbLista_Usuarios;
   public JLabel jlTitulo,jlImg;
   public ArrayList<Datos> arregloUsuarios = new ArrayList<>();
    ...
    private void crearGUI() {
        ...
        add(jbProductos);
        jbLista_Usuarios =new JButton("Lista de Usuarios");
        jbLista_Usuarios.setBounds(400,250,200,30);
        jbLista_Usuarios.setForeground(Color.BLUE);
        jbLista_Usuarios.addActionListener(mpc);
        add(jbLista_Usuarios);
